...
class MappingTests(unittest.TestCase):
    def test_grayscale_tracks_value(self):
        self.assertEqual(grayscale((0.0, 0.5, 1.0)), (Color(0,0,0), Color(128,128,128), Color(255,255,255)))
    ...
    def test_activation_radius_is_monotonic(self):
        r = activation_radii((0, .5, 1))
        self.assertLess(r[0], r[1]); self.assertLess(r[1], r[2])
