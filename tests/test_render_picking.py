...
from zanim import Canvas, Circle, Color, Object2D, Rectangle, Scene, Style, Transform2D
...
class RenderPickingTests(unittest.TestCase):
    def test_topmost_real_raster_wins(self):
        ...
        scene.add(Object2D(Rectangle(6, 4), style=Style(fill=Color(50, 100, 200))))
        scene.add(Object2D(
            Circle(1),
            style=Style(fill=Color(240, 80, 80)),
    ...
    def test_empty_or_non_rendering_pixels_are_not_pickable(self):
        ...
        scene.add(Object2D(Circle(1)))  # no fill or stroke
        snapshot = scene.evaluate(0)
